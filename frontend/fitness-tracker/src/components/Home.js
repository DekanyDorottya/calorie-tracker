...
const Home = () => {
  return (
    <div>
        <div className="homeTitle"><h1>Welcome to TrackFit!</h1></div>
...
Want to eat more mindfully? Track meals, learn about your habits, and reach your goals with TrackFit..</p>
      </div>
    </div>
  );
};
